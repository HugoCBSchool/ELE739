...
#
# Generated by Vivado on Sun Apr 04 12:28:42 -0400 2021
...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../project_3.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../project_3.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl" \
  2>&1 | tee -a vhdlan.log
